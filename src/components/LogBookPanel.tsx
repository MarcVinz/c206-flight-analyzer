...
import { BookOpen, Mail, Clock, Navigation, Gauge, Timer, PlaneLanding, Fuel, Save } from 'lucide-react'
  ...
  return (
    <div className="aviation-card p-5">
      <div className="hidden lg:flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold">{t('flightLog')}</h3>
      </div>
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-xs text-muted-foreground">{t('hobbsStart')}</Label>
              <Input
                type="number"
                step="0.1"
                placeholder="0.0"
            ...
            <div>
              <Label className="text-xs text-muted-foreground">{t('hobbsEnd')}</Label>
              <Input
                type="number"
                step="0.1"
                placeholder="0.0"
          ...
          {hobbsTime !== null && (
            <div className="mt-2 text-center">
              <span className="text-sm text-muted-foreground">{t('hobbsTime')} </span>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-xs text-muted-foreground">{t('blockOut')}</Label>
            ...
            <div>
              <Label className="text-xs text-muted-foreground">{t('blockIn')}</Label>
              <div className="flex gap-1">
                <Input
                  type="time"
                  value={blockIn}
          ...
          {calculatedBlockTime !== null && (
            <div className="mt-2 text-center">
              <span className="text-sm text-muted-foreground">{t('blockTimeLabel')} </span>
        ...
        <div>
          ...
          <Input
            type="text"
            placeholder={t('flightTimePlaceholder')}
            value={flightTime}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-xs text-muted-foreground">{t('initial')}</Label>
              <Input
                type="text"
            ...
            <div>
              <Label className="text-xs text-muted-foreground">{t('remainingGal')}</Label>
              <Input
                type="number"
                min="0"
      ...
      <div className="mt-6 flex gap-3">
        <Button variant="outline" onClick={saveFlightPdf} className="flex-1 flex items-center justify-center gap-2">
          <Save className="h-4 w-4" />
          {t('saveAsPdf')}
        </Button>
        <Button variant="outline" onClick={sendLogbookEmail} className="flex-1 flex items-center justify-center gap-2">
